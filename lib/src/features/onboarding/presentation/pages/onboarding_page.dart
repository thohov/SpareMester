      ...
      body: SafeArea(
        ...
        pages: [
          ...
          PageViewModel(
            ...
            body: 'Legg til produkter du ønsker, og appen setter en tenketid basert på pris. Du får varsel når tiden er ute!',
            image: Center(
              child: Icon(
                Icons.timer,
                size: 150,
          ...
          PageViewModel(
            title: '📂 Kategorier',
            body: 'Organiser ønskene dine i kategorier som Elektronikk, Klær, Hobby og mer. Se statistikk over hva du bruker mest på!',
            image: Center(
              child: Icon(
                Icons.category,
                size: 150,
          ...
          PageViewModel(
            ...
            body: 'Før du kjøper, må du svare på to viktige spørsmål: Trenger jeg virkelig dette? Har jeg noe tilsvarende fra før?',
            image: Center(
              child: Icon(
          ...
          PageViewModel(
            ...
            body: 'Usikker? Du kan alltid forlenge tenketiden med 1-30 dager ekstra før du bestemmer deg!',
            image: Center(
              child: Icon(
                Icons.snooze,
                size: 150,
          ...
          PageViewModel(
            title: '🏆 Prestasjoner',
            body: 'Lås opp over 30 prestasjoner ved å spare penger og ta gode beslutninger. Fiksjon med konfetti når du oppnår noe!',
            image: Center(
              child: Icon(
                Icons.emoji_events,
                size: 150,
          ...
          PageViewModel(
            title: '📊 Statistikk',
            body: 'Se detaljert oversikt over spare-beslutninger, kategorier, månedlig forbruk og sparemål!',
            image: Center(
              child: Icon(
                Icons.bar_chart,
                size: 150,
          ...
          PageViewModel(
            ...
            body: 'Sett et budsjett og få varsler når du nærmer deg grensen. Hold kontroll på forbruket ditt!',
            image: Center(
              child: Icon(
